                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control" id="author_role" name="author_role" value="">
                                <div class="form-text">
                                </div>
                            </div>
                        </div>
            ...
            <section class="card mb-4">
                <div class="card-body">
                    ...
                    <div class="form-check form-switch mb-3">
                        <input class="form-check-input" role="switch" type="checkbox" name="is_published" value="1" id="is_published">
