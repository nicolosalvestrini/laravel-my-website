            ...
            <section class="card mb-4">
                <div class="card-body">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control" id="name" name="name" value="React">
                        <div class="form-text">
                        </div>
                    </div>
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control" id="icon" name="icon" value="react">
                        <div class="form-text">
            ...
            <section class="card mb-4">
                <div class="card-body">
                    ...
                    <div class="form-check form-switch mb-3">
                        <input class="form-check-input" role="switch" type="checkbox" name="show_in_skills" value="1" id="show_in_skills" checked>
