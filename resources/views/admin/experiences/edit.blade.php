            ...
            <section class="card mb-4">
                <div class="card-body">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control" id="title" name="title" value="Corso Full Stack Web Development — Boolean">
                        <div class="form-text">
                        </div>
                    </div>
                    <div class="mb-4">
                        ...
                        <textarea class="form-control" id="description" name="description" rows="6">Percorso di formazione in sviluppo web: HTML, CSS, JavaScript, React, PHP, Laravel e database relazionali.</textarea>
                        <div class="form-text">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-4">
                                ...
                                <input type="date" class="form-control" id="period_start" name="period_start" value="2024-01-01">
                                <div class="form-text">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-4">
                                ...
                                <input type="date" class="form-control" id="period_end" name="period_end" value="2025-01-01">
                                <div class="form-text">
